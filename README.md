...
# To run:
* Create a ".env" file containing your token for the bot (in the format `TEAMSTOKEN = 'insert-token-here'` ), copy the path of that file, and paste it into the "dotenv_path" variable. 
